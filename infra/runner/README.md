...
The dedicated host passed this gate on release `65f3688`. The installed `runsc` fingerprint exactly matched the binary extracted from the checksum-verified official `release-20260914.0` ARM64 archive. The three evidence values and verification chain are retained in the review record.
