...
Current: the stage 6 runtime images, all 14 dedicated-host gVisor isolation tests, the idle supervisor/janitor lifecycle drill, and the restricted worker dependency check pass. Complete the supervisor crash drill, controlled live judging, measured-resource acceptance and independent review before launch. Execution stays off until every runner and judging launch check passes.
