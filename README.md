...
| 8. Frontend integration | Replace generated UI mocks with typed REST/Socket.IO adapter | End-to-end login, Run, Submit, cancel, reconnect and history pass | In progress—live Auth0 login/session pass; remaining browser flows pending |
