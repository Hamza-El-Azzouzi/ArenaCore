...
Current: the stage 6 runtime images, all 14 dedicated-host gVisor isolation tests, and the idle supervisor/janitor lifecycle drill pass. Complete the supervisor crash drill, trusted-worker dependency/live-judging checks, measured-resource acceptance and independent review before launch. Execution stays off until every runner and judging launch check passes.
