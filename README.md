...
Current: the stage 6 runtime images and all 14 dedicated-host gVisor isolation tests pass. Complete supervisor/janitor lifecycle drills, trusted-worker live judging and measured-resource acceptance before launch. Execution stays off until every runner and judging launch check passes.
