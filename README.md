...
| 9. Production operations | IaC, CI/CD, staging, secrets, telemetry, backups, restore, rollback, capacity and abuse limits | Security review, load test, restore and rollout drills pass | In progress—encrypted off-host upload passes; live restore, monitoring, rollback and load drills pending |
