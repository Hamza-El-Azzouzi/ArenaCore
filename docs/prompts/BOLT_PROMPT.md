# ArenaCore prompt for bolt

Copy everything below this line into bolt. Each prompt is standalone; use one tool to generate the initial frontend, then keep one exported codebase as the source of truth.

---

Create the following application in this workspace. Use Next.js rather than substituting a Vite project. Install compatible dependencies, start the preview, and fix build/runtime issues you can verify.
